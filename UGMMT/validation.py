...
def general_validation(args, input2output, input_tensor2string, boundaries, valid_loader, validset_len, model_name, trainset, epoch,
    ...
    with torch.no_grad():
        ...
        print('fp Similarity => mean: ' + str(round(similarity_mean, 3)) + '   std: ' + str(
        ...
        return similarity_mean, property_mean, SR_mean, validity_mean, novelty_mean, diversity_mean, PL_mean
